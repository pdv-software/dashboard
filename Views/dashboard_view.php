...
?>
 ...
 <div id="editicon" class="hidden-phone" style="text-align:center; position:fixed;z-index:1; width: 35px; height: 35px; top:53px; right: 0px;">
	<div id="innerbutton" style="cursor: default";>
		<a href='<?php echo ($path.'dashboard/edit?id='); ?> <?php echo $dashboard['id']; ?>' title='<?php echo _("edit Dashboard"); ?>'> <img src='<?php echo ($path.'Modules/dashboard/Views/icons/gear-icon-outlined.png'); ?>' style="width:80%" ></a>
	</div>
</div>
